...
return [
    ...
    'directory_list' => [
        'src',
        'vendor/alcaeus/mongo-php-adapter/lib/Alcaeus/MongoDbAdapter',
        'vendor/alcaeus/mongo-php-adapter/lib/Mongo',
        'vendor/doctrine/data-fixtures/lib/Doctrine/Common/DataFixtures',
        'vendor/doctrine/doctrine-cache-bundle',
        'vendor/doctrine/mongodb-odm-bundle',
        'vendor/doesntmattr/mongodb-migrations/src/AntiMattr',
        'vendor/graviton/deploy-scripts/src',
        'vendor/graviton/json-schema/src',
        'vendor/graviton/php-proxy/src',
        'vendor/graviton/php-rql-parser/src',
        'vendor/graviton/rql-parser-bundle/src',
        'vendor/guzzlehttp/guzzle/src',
        'vendor/incenteev/composer-parameter-handler',
        'vendor/jean85/pretty-package-versions/src',
        'vendor/jms/serializer-bundle',
        'vendor/johnkary/phpunit-speedtrap/src',
        'vendor/justinrainbow/json-schema/src/JsonSchema',
        'vendor/league/flysystem-aws-s3-v3/src',
        'vendor/liip/functional-test-bundle/src',
        'vendor/oneup/flysystem-bundle',
        'vendor/phan/phan/src/Phan',
        'vendor/php-amqplib/rabbitmq-bundle',
        'vendor/php-jsonpatch/php-jsonpatch/src',
        ...
        'vendor/solarium/solarium/src',
        'vendor/symfony/monolog-bundle',
        'vendor/symfony/phpunit-bridge',
        'vendor/symfony/psr-http-message-bridge',
        'vendor/symfony/symfony/src/Symfony/Bridge/Doctrine',
        'vendor/symfony/symfony/src/Symfony/Bridge/Monolog',
        'vendor/symfony/symfony/src/Symfony/Bridge/ProxyManager',
        'vendor/symfony/symfony/src/Symfony/Bridge/Twig',
        'vendor/symfony/symfony/src/Symfony/Bundle',
        'vendor/symfony/symfony/src/Symfony/Component',
        'vendor/symfony/symfony/src/Symfony/Component/Intl/Resources/stubs',
        'vendor/thefrozenfire/swagger/src',
        'vendor/thefrozenfire/swagger/tests',
    ],
